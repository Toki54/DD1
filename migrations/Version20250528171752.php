 ...
 */
final class Version20250528171752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_interest ADD CONSTRAINT FK_8CB3FE67EEB16BFD FOREIGN KEY (source_user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_interest ADD CONSTRAINT FK_8CB3FE676C066AFE FOREIGN KEY (target_user_id) REFERENCES user (id)');
    }
